...
export const teamdata = [
    ...
    { id: 2, image: IMAGES.team2, dealy: '0.4s', title: 'Nashid Martines', },
    { id: 3, image: IMAGES.team3, dealy: '0.6s', title: 'Nashid Martines', },
    { id: 4, image: IMAGES.team4, dealy: '0.8s', title: 'Nashid Martines', },
]
...
export const blogdata = [
    { image: IMAGES.blogmiddle1, dealy: '0.2s', title: 'Radiant reflections expert dermatology and skin.', },
    { image: IMAGES.blogmiddle2, dealy: '0.4s', title: 'Glow guide your path to perfect skin health', },
    { image: IMAGES.blogmiddle3, dealy: '0.6s', title: 'Brilliant skin blog your dermatology care resource', },
    { image: IMAGES.blogmiddle1, dealy: '0.8s', title: 'Radiant reflections expert dermatology and skin.', },
    { image: IMAGES.blogmiddle2, dealy: '1.0s', title: 'Glow guide your path to perfect skin health', },
    { image: IMAGES.blogmiddle3, dealy: '1.2s', title: 'Brilliant skin blog your dermatology care resource', },
]
// sidebar 
...
export const contactusdata = [
    ...
    },
    {
        ...
        delay: "0.4s",
        para: <p>
            <Link to="tel:+01234567890" className="text-body">+0 123-456-7890</Link><br />
            <Link to="tel:+09876543210" className="text-body">+0 987-654-3210</Link>
        </p>,
    },
    {
        id: 3,
        ...
        delay: "0.6s",
        para: <p>
            <Link to="mailto:info@example.com" className="text-body">info@example.com</Link><br />
            <Link to="mailto:medical@example.com" className="text-body">medical@example.com</Link>
        </p>,
    },
    {
        id: 4,
